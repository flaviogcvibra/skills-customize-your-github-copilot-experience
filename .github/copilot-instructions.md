...
Neste projeto utilizamos o padrão Conventional Commits para as mensagens de commit, garantindo um histórico claro e automatizável. Use o formato tipo(escopo opcional): descrição, por exemplo: feat, fix, docs, style, refactor, test, chore. Para mudanças incompatíveis, adicione ! após o tipo e descreva no corpo com BREAKING CHANGE. Detalhes em https://www.conventionalcommits.org/pt-br/v1.0.0/.
